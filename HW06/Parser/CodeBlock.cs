using HW06.Parser.Nodes;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Text;

namespace HW06.Parser
{
    /// <summary>
    ...
    class CodeBlock
    {
        ...
        /// </summary>
        private Dictionary<string, Lexer.Token> definitions;
        ...
        /// <summary>
        /// Checks, whether block of code stores definition
        /// </summary>
        /// <param name="name">Name of definition which will be checked</param>
        /// <returns>TRUE if block of code stores definition, FALSE otherwise</returns>
        public bool HasDefinition(string name)
        {
            ...
            {
                reti = this.parent.HasDefinition(name);
            }
            return reti;
        }

        /// <summary>
        /// Sets definition to variable
        /// </summary>
        /// <param name="name">Name of variable</param>
        /// <param name="definition">Definition pf variable</param>
        public void SetDefinition(string name, Lexer.Token definition)
        {
            if (this.definitions.ContainsKey(name))
            {
        ...
        /// <summary>
        /// Gets definition of variable
        /// </summary>
        /// <param name="name">Name of variable</param>
        /// <returns>Definition of variable</returns>
        public Lexer.Token GetDefinition(string name)
        {
            Lexer.Token reti = null;
            if (this.definitions.ContainsKey(name))
            {
                reti = this.definitions[name];
            }
            return reti;
        }
