...
namespace HW03.Lexer
{
    ...
    {
        /// <summary>
        /// Class representing results of lexer
        /// </summary>
        public class LexerResults
        {
            ...
            /// <summary>
            /// Creates new output of lexer
            /// </summary>
            /// <param name="tokens"></param>
            public LexerResults(IList<Token> tokens)
            {
                this.tokens = new Token[tokens.Count];
        ...
        /// </summary>
        /// <returns>Results of lexer</returns>
        public LexerResults GetResults()
        {
            return new LexerResults(this.results);
        }
    }
}
