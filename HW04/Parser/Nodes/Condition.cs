    ...
    class Condition : ExecutableNode
    {
        ...
        public override void Execute()
        {
            if (this.isOdd)
            {
                ...
                {
                    Parser.PrintError("Cannot execute condition (right side has no value)!", this.token);
                }
            }
            else
            {
                ...
                {
                    Parser.PrintError("Cannot execute condition (left side has no value)!", this.token);
                }
            }
        }
    }
