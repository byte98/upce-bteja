    ...
    class Factor : ExecutableNode
    {
        ...
        public override void Execute()
        {
            if (this.isIdentifier)
            {
                ...
                {
                    Parser.PrintError("Unknown variable '" + this.identifier + "' found in factor execution!", this.token);
                }
            }
            ...
            else if (this.isExpression)
            {
                ...
                {
                    Parser.PrintError("Cannot execute factor! Unknown expression value!", this.token);
                }
            }
            else
            {
                Parser.PrintError("Cannot execute factor! Unknown value!", this.token);
            }
        }
    }
}
